...
const QuestionModification = (props) => {
    const [content, setContent] = useState(props.question.content);
    const [typeAnswer, setTypeAnswer] = useState(props.question.typeAnswer);
    const [description, setDescription] = useState(props.question.description);
    const [module, setModule] = useState(props.question.module);
    ...
    const setOnMod = () => {
        ...
        axios.put(ModQuestionUrl, JSON.stringify(question), { withCredentials: true,
            headers: {
