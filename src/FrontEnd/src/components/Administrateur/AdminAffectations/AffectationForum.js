...
import styles from "../AdminStyle/styles.module.css";
import styleSwitchButton from "../AdminStyle/styleSwitchButton.module.css";
import "../AdminStyle/react-select-search.css"
  ...
  return (
    <div style={{zIndex: "3"}}>    
      <div className={styles.btns}>
        <a className={styles.btn +' '+ styles.bg + ' '+ expandedClass} onClick={handleExpandClick}>Add Affectation</a>
        <ExpandMore
              expand={expanded}
