import { Button, Card, CardContent, Grid,TextField ,CardHeader, Container, Typography } from "@mui/material";
import React from "react";
import Question from "../Questions/QuestionConsultation/Question/Question";
import LayersClearIcon from '@mui/icons-material/LayersClear';

const AddedQuestionList : React.FC<{addedQuestions,removeQuestion}> = (props)=>{
