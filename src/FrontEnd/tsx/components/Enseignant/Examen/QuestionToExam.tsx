...
import QuestionInExam from "./QuestionInExam";
import LibraryAddIcon from '@mui/icons-material/LibraryAdd';


const QuestionToExam : React.FC<{questions,setQuestions,AddQuestion,AddedQuestions,module}> = (props)=>{
                            ...
                            <CardContent>
                                ...
                                <Grid container>
                                    ...
                                    <Grid item xs={12} marginBottom="3%">
                                        <TextField variant="standard" label="Points" type="number" onChange={e => {exo.points = e.target.value as any}}></TextField>
                                    </Grid>
                                    <Grid item xs={12}>
