import { Button,Drawer, Grid, List, ListItem, ListItemIcon, ListItemText, Toolbar,AppBar, Typography, Theme } from "@mui/material";
...
const Enseignant = ()=>{
    ...
    const [affectationModule,setAffectationModule] = useState<any[]>();
                                    ...
                                    {menuItems.map(item => {
                                            return(
                                                <ListItem 
                                                    key={item.text}
                                                    button
                                                    disabled={!(item.alwaysShow || (currentModule.type === "COURS"))}
                                                    onClick={(e)=>{goTo(item)}}>
